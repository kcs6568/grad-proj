...
from lib.model_api.modules.disparse_api import engines
...
# tasks: set of tasks
def disparse_prune_static(
    net, train_loader, num_batches, keep_ratio, logger, args):
    ...
    grads = engines.get_grads(
        test_net, train_loader, 
        num_batches, logger, args)
