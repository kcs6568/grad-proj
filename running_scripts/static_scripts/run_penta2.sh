...
KILL_PROC="kill $(ps aux | grep static_train2.py | grep -v grep | awk '{print static}')"
...
then
    CFG_PATH=/root/src/gated_mtl/cfgs/five_task/static/fashion_cifar10_stl10_minicoco_voc
fi
