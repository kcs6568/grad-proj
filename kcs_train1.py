...
def adjust_gate_lr(gate_params, current_epoch, args):
    lr = gate_params['lr']
    lr *= (1 - ((current_epoch+1)/args.epochs))**2
    gate_params['lr'] = lr
    
    
    # for i, param_group in enumerate(gate_params):
    #     print(param_group)
    #     lr = param_group['lr']
    #     lr *= (1 - (current_epoch/args.epochs))**2
    #     param_group['lr'] = lr
